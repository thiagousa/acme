...
<article id="one" class="post style1">
    <div class="image">
        <img src="../../../public/images/pic14.jpg" alt="" data-position="75% center" />
    </div>
    <div class="content">
        <div class="inner">
            <header>
...
<article id="two" class="post invert style1 alt">
    <div class="image">
        <img src="../../../public/images/pic13.jpg" alt="" data-position="10% center" />
    </div>
    <div class="content">
        <div class="inner">
            <header>
...
<article id="three" class="post style2">
    <div class="image">
        <img src="../../../public/images/pic12.jpg" alt="" data-position="80% center" />
    </div>
    <div class="content">
        <div class="inner">
            <header>
...
<article id="four" class="post invert style2 alt">
    <div class="image">
        <img src="../../../public/images/pic14.jpg" alt="" data-position="60% center" />
    </div>
    <div class="content">
        <div class="inner">
            <header>
...
<article id="five" class="post style3">
    <div class="image">
        <img src="../../../public/images/pic13.jpg" alt="" data-position="5% center" />
    </div>
    <div class="content">
        <div class="inner">
            <header>
